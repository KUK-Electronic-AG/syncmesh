...
{
    public class MigrateInvoices : DataMigrationBase
    {
        public override string MigrationName => "MigrateInvoices";
...
            var invoices = new List<ModelsNewSchema.Invoice>();
...
                var newInvoice = new ModelsNewSchema.Invoice
                {
