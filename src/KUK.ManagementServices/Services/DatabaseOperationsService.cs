...
namespace KUK.ManagementServices.Services
{
    public class DatabaseOperationsService : IDatabaseOperationsService
    {
            ...
            IUtilitiesService utilitiesService)
        {
            ...
            var newOptions = new DbContextOptionsBuilder<Chinook2Context>()
                .UseNpgsql(newDatabaseConnectionString)
                .Options;
            _newSchemaContext = new Chinook2Context(newOptions, configuration, utilitiesService);
        ...
        {
            Common.ModelsOldSchema.Customer customer = TestData.OldCustomer;
        ...
        {
            Common.ModelsOldSchema.Invoice invoice = TestData.OldInvoice;
            ...
            invoice.InvoiceLines = new List<KUK.Common.ModelsOldSchema.InvoiceLine>()
            {
                new Common.ModelsOldSchema.InvoiceLine() { InvoiceId = invoice.InvoiceId, Quantity = 1, UnitPrice = 1, TrackId = 1 },
                new Common.ModelsOldSchema.InvoiceLine() { InvoiceId = invoice.InvoiceId, Quantity = 2, UnitPrice = 2, TrackId = 2 }
            };
        ...
        {
            Common.ModelsNewSchema.Customer customer = TestData.NewCustomer;
        ...
        {
            Common.ModelsNewSchema.Invoice invoice = TestData.NewInvoice;
            ...
            invoice.InvoiceLines = new List<KUK.Common.ModelsNewSchema.InvoiceLine>()
            {
                new Common.ModelsNewSchema.InvoiceLine() { InvoiceId = invoice.InvoiceId, Quantity = 1, UnitPrice = 1, TrackId = 1 },
                new Common.ModelsNewSchema.InvoiceLine() { InvoiceId = invoice.InvoiceId, Quantity = 2, UnitPrice = 2, TrackId = 2 }
            };
        ...
        private async Task<Common.ModelsOldSchema.InvoiceLine> FindFirstInvoiceLineInOldDatabase(
            OldInvoiceOperationResult createdInvoiceInOldDatabase,
            bool useNoTracking)
        {
            IQueryable<Common.ModelsOldSchema.Invoice> query = _oldSchemaContext.Invoices.Include(i => i.InvoiceLines);
            if (useNoTracking)
            {
        ...
        private async Task<Common.ModelsNewSchema.InvoiceLine> FindFirstInvoiceLineInNewDatabase(OldInvoiceOperationResult createdInvoiceInOldDatabase)
        {
        ...
        private async Task<Common.ModelsOldSchema.InvoiceLine> FindSecondInvoiceLineInOldDatabase(NewInvoiceOperationResult createdInvoiceInNewDatabase)
        {
        ...
        private async Task<Common.ModelsNewSchema.InvoiceLine> FindSecondInvoiceLineInNewDatabase(
            NewInvoiceOperationResult createdInvoiceInNewDatabase, bool useNoTracking)
        {
            IQueryable<Common.ModelsNewSchema.Invoice> query = _newSchemaContext.Invoices.Include(i => i.InvoiceLines);
            if (useNoTracking)
            {
                query = query.AsNoTracking();
            }
