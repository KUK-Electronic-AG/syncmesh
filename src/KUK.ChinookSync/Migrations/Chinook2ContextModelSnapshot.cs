...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Address", b =>
                {
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Customer", b =>
                {
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Invoice", b =>
                {
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.InvoiceLine", b =>
                {
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Mapping.AddressMapping", b =>
                {
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Mapping.CustomerMapping", b =>
                {
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Mapping.InvoiceLineMapping", b =>
                {
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Mapping.InvoiceMapping", b =>
                {
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Outbox.BaseOutbox", b =>
                {
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Outbox.ProcessedMessagesNew", b =>
                {
                    b.Property<string>("UniqueIdentifier")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Outbox.AddressOutbox", b =>
                {
                    b.HasBaseType("KUK.ChinookSync.Models.NewSchema.Outbox.BaseOutbox");

                    b.ToTable("AddressOutbox", "public");
                });

            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Outbox.CustomerOutbox", b =>
                {
                    b.HasBaseType("KUK.ChinookSync.Models.NewSchema.Outbox.BaseOutbox");
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Outbox.InvoiceLineOutbox", b =>
                {
                    b.HasBaseType("KUK.ChinookSync.Models.NewSchema.Outbox.BaseOutbox");
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Outbox.InvoiceOutbox", b =>
                {
                    b.HasBaseType("KUK.ChinookSync.Models.NewSchema.Outbox.BaseOutbox");
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Customer", b =>
                {
                    b.HasOne("KUK.ChinookSync.Models.NewSchema.Address", "Address")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Invoice", b =>
                {
                    b.HasOne("KUK.ChinookSync.Models.NewSchema.Address", "BillingAddress")
                        .WithMany("Invoices")
                        .HasForeignKey("BillingAddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("KUK.ChinookSync.Models.NewSchema.Customer", "Customer")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.InvoiceLine", b =>
                {
                    b.HasOne("KUK.ChinookSync.Models.NewSchema.Invoice", "Invoice")
            ...
            modelBuilder.Entity("KUK.ChinookSync.Models.NewSchema.Mapping.AddressMapping", b =>
                {
                    b.HasOne("KUK.ChinookSync.Models.NewSchema.Address", "NewAddress")
                        .WithMany()
