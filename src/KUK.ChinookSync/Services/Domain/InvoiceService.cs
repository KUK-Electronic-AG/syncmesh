    ...
    public class InvoiceService : IInvoiceService
    {
        ...
        public async Task AddToNewDatabase(JObject eventBody, string syncId, string uniqueIdentifier)
        {
            ...
            using (var newContext = _newContextFactory.CreateDbContext())
            {
                ...
                var oldInvoice = JsonConvert.DeserializeObject<Models.OldSchema.Invoice>(eventBody.ToString(), settings);
        ...
        public async Task AddToOldDatabase(JObject eventBody, string syncId, string uniqueIdentifier)
        {
            ...
            using (var oldContext = _oldContextFactory.CreateDbContext())
            {
                ...
                var newInvoice = JsonConvert.DeserializeObject<Models.NewSchema.Invoice>(eventBody.ToString(), settings);
                ...
                var oldInvoice = new Models.OldSchema.Invoice
                {
        ...
        public async Task DeleteFromNewDatabase(JObject eventBody, string syncId, string uniqueIdentifier)
        {
            ...
            using (var newContext = _newContextFactory.CreateDbContext())
            {
                ...
                var oldInvoice = JsonConvert.DeserializeObject<Models.OldSchema.Invoice>(eventBody.ToString(), settings); // Użycie Common.ModelsOldSchema
                if (oldInvoice == null)
                {
        ...
        private async Task CompensateOldInvoiceAddition(Models.OldSchema.Invoice oldInvoice, string syncId)
        {
